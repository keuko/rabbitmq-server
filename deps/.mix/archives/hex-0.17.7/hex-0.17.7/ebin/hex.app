{application,hex,
             [{description,"hex"},
              {modules,['Elixir.Hex','Elixir.Hex.API','Elixir.Hex.API.Auth',
                        ...
                        'Elixir.Mix.Tasks.Hex.User',vendored_hex_erl_tar,
                        vendored_hex_filename,vendored_hex_pb_package,
                        vendored_hex_pb_signed,vendored_hex_registry,
                        vendored_hex_tarball,vendored_safe_erl_term]},
              {registered,[]},
              {vsn,"0.17.7"},
